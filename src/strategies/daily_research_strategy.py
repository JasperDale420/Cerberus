"""Daily Research Strategy — wide stops, vol-targeted sizing, multi-signal."""
...
class DailyResearchStrategy(BaseStrategy):
    ...
    def _sig(self, sym: str, bar: Bar, ms: MarketState) -> Signal | None:
        ...
        # Vol-targeted sizing with regime boost
        ...
        # Wide stop: 3 ATR survives daily noise, trailing stop handles exit
