...
LOCKED_PARAMS: dict[str, dict[str, Any]] = {
    ...
    "daily_research_v6a": {"stop_atr_mult": 1.5},
}
...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_v6a": [
        ParamDef("rsi2_threshold", "float", low=10.0, high=25.0, step=5.0, description="RSI(2) oversold threshold"),
        ParamDef("target_atr_mult", "float", low=1.5, high=3.5, step=0.5, description="ATR target"),
        ParamDef("max_hold_days", "int", low=3, high=10, step=1, description="Max hold days"),
    ],
}
