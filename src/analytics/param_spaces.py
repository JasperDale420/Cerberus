...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_strategy": [
        ...
        ParamDef("rsi2_threshold", "float", low=5.0, high=20.0, step=5.0, description="RSI(2) oversold"),
        ParamDef("breakout_period", "int", low=10, high=30, step=5, description="Breakout lookback"),
        ParamDef("vol_mult", "float", low=0.8, high=1.5, step=0.1, description="Volume filter mult"),
        ParamDef("roc_period", "int", low=10, high=30, step=5, description="Rate of change period"),
    ],
}
