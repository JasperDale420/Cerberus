...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_strategy": [
        ParamDef("stop_atr_mult", "float", low=1.0, high=2.5, step=0.25, description="ATR stop"),
        ParamDef("target_atr_mult", "float", low=6.0, high=14.0, step=1.0, description="ATR target wide"),
        ...
        ParamDef("consistency_bars", "int", low=3, high=8, step=1, description="Trend consistency bars"),
