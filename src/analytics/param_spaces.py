...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_strategy": [
        ParamDef("stop_atr_mult", "float", low=1.5, high=3.5, step=0.5, description="ATR multiplier for stop loss"),
        ParamDef("target_atr_mult", "float", low=1.5, high=4.0, step=0.5, description="ATR multiplier for target"),
        ParamDef("rsi_threshold", "float", low=30.0, high=50.0, step=5.0, description="RSI oversold threshold"),
        ParamDef("min_signals", "int", low=1, high=3, step=1, description="Min signals required to enter"),
    ],
}
