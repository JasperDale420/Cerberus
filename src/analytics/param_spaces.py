...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_v7d": [
        ParamDef("ibs_threshold", "float", low=0.15, high=0.30, step=0.05, description="IBS entry threshold"),
        ParamDef("target_atr_mult", "float", low=1.5, high=2.5, step=0.5, description="ATR target"),
        ParamDef("max_hold_days", "int", low=3, high=7, step=1, description="Max hold days"),
        ParamDef("max_stop_pct", "float", low=0.02, high=0.035, step=0.005, description="Max stop loss pct"),
    ],
}
