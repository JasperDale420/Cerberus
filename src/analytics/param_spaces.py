...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_v7d": [
        ParamDef("consec_down_days", "int", low=2, high=3, step=1, description="Consecutive down days"),
        ParamDef("rsi_max", "float", low=8.0, high=20.0, step=2.0, description="RSI(2) oversold threshold"),
        ParamDef("target_atr_mult", "float", low=1.0, high=2.0, step=0.25, description="ATR target"),
        ParamDef("max_stop_pct", "float", low=0.02, high=0.03, step=0.005, description="Max stop loss pct"),
    ],
}
