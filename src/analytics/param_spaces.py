...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_strategy": [
        ParamDef("stop_atr_mult", "float", low=1.0, high=2.5, step=0.25, description="ATR stop"),
        ParamDef("target_atr_mult", "float", low=4.0, high=12.0, step=1.0, description="ATR target wide"),
        ParamDef("rsi_threshold", "float", low=25.0, high=50.0, step=5.0, description="RSI threshold"),
        ParamDef("breakout_period", "int", low=10, high=25, step=5, description="Breakout lookback"),
    ],
}
