...
PARAM_SPACES: dict[str, list[ParamDef]] = {
    ...
    "daily_research_v7d": [
        ParamDef("ibs_threshold", "float", low=0.10, high=0.25, step=0.05, description="IBS entry threshold"),
        ParamDef("min_consec_down", "int", low=2, high=4, step=1, description="Min consecutive down days"),
        ParamDef("target_atr_mult", "float", low=1.5, high=3.5, step=0.5, description="ATR target"),
