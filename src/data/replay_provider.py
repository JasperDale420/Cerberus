        ...
        try:
            with self.db.get_session() as session:
                ...
                if result:
                    ...
                    features_dict = (
                        result.features_json if isinstance(result.features_json, dict) else {}
                    )
                    ...
                    features = SymbolFeatures(
                        ...
                        intraday_range_pct=self._to_float(
                            features_dict.get("intraday_range_pct"), 0.0
                        ),
                        gap_pct=self._to_float(features_dict.get("gap_pct"), 0.0),
                        ema20_slope=self._to_float(features_dict.get("ema20_slope"), 0.0),
                        ema_trend_strength=self._to_float(
                            features_dict.get("ema_trend_strength"), 0.0
                        ),
                        distance_from_vwap=self._to_float(
                            features_dict.get("distance_from_vwap"), 0.0
                        ),
                        premarket_volume=self._to_float(
                            features_dict.get("premarket_volume"), 0.0
                        ),
                        adx=self._to_float(features_dict.get("adx"), 0.0),
                        distance_from_ema20=self._to_float(
                            features_dict.get("distance_from_ema20"), 0.0
                        ),
                        prior_day_high=self._to_float(
                            features_dict.get("prior_day_high"), 0.0
                        ),
                        ...
                        call_put_ratio=self._to_float(
                            features_dict.get("call_put_ratio"), 0.0
                        ),
                        large_sweeps_count=self._to_int(
                            features_dict.get("large_sweeps_count"), 0
                        ),
                        aggressive_flow_share=self._to_float(
                            features_dict.get("aggressive_flow_share"), 0.0
                        ),
                        last_updated=result.as_of_ts,
                        relative_strength=self._to_float(
                            features_dict.get("relative_strength"), 0.0
                        ),
                        ...
                        net_gex=self._to_float(
                            result.net_gex, self._to_float(features_dict.get("net_gex"), 0.0)
                        ),
                        ...
                        frac_diff_close=self._to_float(
                            ...
                            self._to_float(
                                features_dict.get(
                                    "frac_diff_close", features_dict.get("frac_diff", 0.0)
                                ),
                                0.0,
                            ),
                        ),
        ...
        try:
            with self.db.get_session() as session:
                ...
                count = (
                    ...
                    .filter(
                        func.date(FeatureSnapshot.as_of_ts) == trade_date.date()
                    )
                    .scalar()
                )
